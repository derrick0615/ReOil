...
(function () {
  const translations = {
    ...
    'issue.cases.title': { zh: '實際案例', en: 'Real-World Consequences' },
    ...
    'product.led.green.title': { zh: '綠燈 — 過濾完成', en: 'Green — Filtration Complete' },
    'product.led.green.desc': { zh: '(可進行清理)', en: '(Ready for cleaning)' },
    ...
    'research.persona1.name': { zh: '家庭主婦/夫', en: 'Senior Home Manager' },
    ...
    'research.persona2.name': { zh: '上班族', en: 'Busy Professional' },
    ...
    'about.thanks.desc': { zh: '衷心感謝指導教授洪綾珠老師在專業知識與實驗材料上的悉心指導與鼎力支持，以及國立臺北商業大學創意科技與產品設計系提供的研究資源，使本專題得以順利完成。同時特別感謝技術合作夥伴、實驗室工作人員，以及參與早期測試的在地協力者。您們對永續未來的堅持，是驅動我們持續創新的最大動力。', en: 'Heartfelt thanks to our advisor, Professor Ling-Chu Hung, for her dedicated guidance and generous support with both expertise and experimental materials, and to the Department of Creative Technology & Product Design at National Taipei University of Business for the research resources that made this project possible. Special thanks also to technical partners, lab staff, and local collaborators who participated in early testing. Your commitment to a sustainable future is our greatest motivation for continued innovation.' },
    'about.thanks.advisor': { zh: '指導教授', en: 'Faculty Advisor' },
    'about.thanks.advisorName': { zh: '洪綾珠 教授', en: 'Prof. Ling-Chu Hung' },
    'about.thanks.academic': { zh: '學術支持', en: 'Academic Support' },
    'about.thanks.academicName': { zh: '國立臺北商業大學 創意科技與產品設計系', en: 'NTUB · Dept. of Creative Technology & Product Design' },
    'about.thanks.material': { zh: '材料贊助', en: 'Material Sponsorship' },
    'about.thanks.materialName': { zh: '洪綾珠 教授', en: 'Prof. Ling-Chu Hung' },
